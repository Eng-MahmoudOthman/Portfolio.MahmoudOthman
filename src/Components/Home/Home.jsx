      ...
      <Fragment>
         ...
         <section className={`${style.services}`}>
            <div className='container'>
               ...
               <div className={`${style.rowServices} row g-4 m-5 cardAnimation`}>
            ...
            <div className="container my-5 py-5">
               <div className="d-flex justify-content-center align-items-center flex-column flex-md-row">
                  <div className='text-center m-5' style={{width:300}}>
                     ...
                     <div>
                        <h4 className='my-4'><Counter target={360} /></h4>
                  ...
                  <div className='text-center m-5' style={{width:300}}>
                     ...
                     <div>
                        <h4 className='my-4'><Counter target={540} /></h4>
                  ...
                  <div className='text-center m-5' style={{width:300}}>
                     ...
                     <div>
                        <h4 className='my-4'><Counter target={4320} /></h4>
                        ...
                        <div className={`${style.cardCarousel}`}>
                           <div className='bg-white rounded-1 p-4'>
                              <p className="text-muted text-center small py-4">
                                 ...
                                 porro quos, fuga voluptatibus magni dolor. Et a aut accusantium ut
                                 sunt dolor, neque fugiat nam nobis atque culpa distinctio
                                 assumenda ipsa iusto, corporis hic quibusdam repudiandae deleniti
                                 dolores ratione nulla soluta vel quos voluptatem. Sunt alias
                                 quibusdam ea suscipit eaque.
                              </p>
                              ...
                              <div className="d-flex justify-content-start align-items-center">
                                 ...
                                 <div className="mx-2">
                                    <h6 className="m-0 p-0 main-color fw-bold">Mahmoud Othman</h6>
